# 📌 SCPC Multimodal Ensemble Model  
...
제안 모델은 **CLIP**과 **SigLIP**을 앙상블하여, 보기별 점수(score)를 산출하고 이를 합산하여 최종 예측값을 결정한다. 본 접근법은 멀티모달 데이터셋에서 약 **71% 분류 정확도**를 보였다:contentReference[oaicite:0]{index=0}:contentReference[oaicite:1]{index=1}.  
